...
subLanguage:"bash"}}]})})();hljs.registerLanguage("shell",s)})();/*! `handlebars` grammar compiled for Highlight.js 11.6.0 */
...
className:"template-variable",begin:/\{\{/,end:/\}\}/,contains:[N]}]}}})()
;hljs.registerLanguage("handlebars",e)})();/*! `perl` grammar compiled for Highlight.js 11.6.0 */
(()=>{var e=(()=>{"use strict";return e=>{
